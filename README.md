...
| 平台 | 要求 | 安装包 |
| --- | --- | --- |
| macOS | macOS 14+，Apple Silicon / Intel | [通用 DMG](https://aliyun-oss.yaklang.com/yconnect/0.5.3/YConnect-0.5.3-darwin-universal.dmg) |
| Windows | Windows 10/11 x64，.NET Framework 4.8 | [安装程序](https://aliyun-oss.yaklang.com/yconnect/0.5.3/YConnect-0.5.3-windows-x64-setup.exe) · [便携 ZIP](https://aliyun-oss.yaklang.com/yconnect/0.5.3/YConnect-0.5.3-windows-x64.zip) |

[GitHub Releases / 更新说明](https://github.com/yaklang/yconnect/releases) · [最新版本](https://aliyun-oss.yaklang.com/yconnect/version.txt) · [SHA-256 校验](https://aliyun-oss.yaklang.com/yconnect/0.5.3/SHA256SUMS.txt)
