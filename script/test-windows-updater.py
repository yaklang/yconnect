...
with tempfile.TemporaryDirectory(prefix='yconnect-update-test-') as temporary:
    ...
    try:
        for tampered in [False,True]:
            ...
            subprocess.run([sys.argv[1],'--verify-updater-native',f'http://127.0.0.1:{server.server_port}/appcast.xml',public,str(tampered)],check=True,timeout=60)
