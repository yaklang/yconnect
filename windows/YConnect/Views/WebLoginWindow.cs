...
namespace YConnect.Views
{
    public sealed class WebLoginWindow : Window
    {
        ...
        {
            this.controller = controller; Title = "Y CONNECT · YAKCOOL 官方扫码登录"; Width = 880; Height = 820; MinWidth = 680; MinHeight = 550; WindowStartupLocation = WindowStartupLocation.CenterScreen; SetResourceReference(BackgroundProperty, "Page"); web.DefaultBackgroundColor = System.Drawing.Color.White;
